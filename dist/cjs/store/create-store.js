...
var getForgePlugins_1 = require("../popup/middleware/getForgePlugins");
...
exports.default = (function (eventEmitter, tenantMediaClient, userMediaClient, config) {
    ...
    var partialState = tslib_1.__assign(tslib_1.__assign({}, default_state_1.default), { redirectUrl: redirectUrl, plugins: config.plugins, tenantMediaClient: tenantMediaClient,
        userMediaClient: userMediaClient,
        config: config });
    return redux_1.createStore(reducers_1.default, partialState, developmentOnly_1.composeWithDevTools(redux_1.applyMiddleware(analyticsProcessing_1.default, startApp_1.default(), getFilesInRecents_1.getFilesInRecents(), getForgePlugins_1.getForgePlugins(), changeService_1.changeService, changeAccount_1.default, changeCloudAccountFolder_1.changeCloudAccountFolderMiddleware(fetcher), fetchNextCloudFilesPage_1.fetchNextCloudFilesPageMiddleware(fetcher), startAuth_1.startCloudAccountOAuthFlow(fetcher, cloudService), unlinkCloudAccount_1.default(fetcher), getConnectedRemoteAccounts_1.getConnectedRemoteAccounts(fetcher), importFiles_1.importFilesMiddleware(eventEmitter, wsProvider), editRemoteImage_1.editRemoteImageMiddleware(), getPreview_1.default(), finalizeUpload_1.default(), handleCloudFetchingEvent_1.handleCloudFetchingEvent, searchGiphy_1.default(fetcher), hidePopup_1.default(eventEmitter), sendUploadEvent_1.default(eventEmitter), removeFileFromRecents_1.removeFileFromRecents)));
});
