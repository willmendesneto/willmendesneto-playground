...
var Navigation = /** @class */ (function (_super) {
    ...
    Navigation.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.FolderViewerNavigation, null,
            breadcrumbs,
            react_1.default.createElement(styled_1.ControlsWrapper, null,
                react_1.default.createElement(styled_1.Controls, null,
                    react_1.default.createElement(styled_1.ControlButton, { onClick: this.onRefreshButtonClick, iconBefore: react_1.default.createElement(refresh_1.default, { label: "refresh" }) }),
                    accountsDropdown))));
    };
    Navigation.prototype.getAccountButton = function () {
        var dropdownOpen = this.state.dropdownOpen;
        return (react_1.default.createElement(styled_1.AccountItemButton, { isSelected: dropdownOpen, iconBefore: react_1.default.createElement(settings_1.default, { label: "account settings" }) }));
    };
    Navigation.prototype.getAccountsDropdownItems = function () {
        ...
        var dropdownAccountItems = availableAccounts.map(function (_a) {
            ...
            return (react_1.default.createElement(dropdown_menu_1.DropdownItem, { key: id, onClick: _this.onChangeAccountHandler(type, id) }, id === service.accountId ? react_1.default.createElement("b", null, displayName) : displayName));
        });
        var dropdownActionItems = [
            react_1.default.createElement(dropdown_menu_1.DropdownItem, { key: "add", onClick: this.onStartAuthHandler(service.name) },
                react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.add_account))),
            react_1.default.createElement(dropdown_menu_1.DropdownItem, { key: "unlink", onClick: this.onUnlinkAccountHandler(service.name, service.accountId) },
                react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.unlink_account))),
        ];
        return [
            react_1.default.createElement(dropdown_menu_1.DropdownItemGroup, { key: "accounts", title: formatMessage(media_ui_1.messages.accounts) }, dropdownAccountItems),
            react_1.default.createElement(dropdown_menu_1.DropdownItemGroup, { key: "actions", title: formatMessage(media_ui_1.messages.actions) }, dropdownActionItems),
        ];
    };
    Navigation.prototype.getAccountsDropdown = function () {
        var items = this.getAccountsDropdownItems();
        return (react_1.default.createElement(styled_1.AccountDropdownWrapper, null,
            react_1.default.createElement(dropdown_menu_1.default, { onOpenChange: this.handleOpenChange, trigger: this.getAccountButton(), position: "bottom right" }, items)));
    };
    Navigation.prototype.generateBreadcrumbs = function (service, path) {
        ...
        return react_1.default.createElement(styled_1.BreadCrumbs, null, breadcrumbs);
    };
    Navigation.prototype.renderBreadcrumb = function (service, path, isLast) {
        ...
        return (react_1.default.createElement(styled_1.BreadCrumbLink, { key: folder.id, onClick: onClick, isLast: isLast },
            react_1.default.createElement(styled_1.BreadCrumbLinkLabel, { title: folder.name, isLast: isLast }, folder.name),
            react_1.default.createElement(styled_1.BreadCrumbLinkSeparator, { isLast: isLast }, "/")));
    };
    return Navigation;
}(react_2.Component));
