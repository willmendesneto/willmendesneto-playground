...
exports.InsertButton = function (props) { return (react_1.default.createElement(button_1.default, tslib_1.__assign({}, props, { theme: function (currentTheme, themeProps) {
...
exports.CancelButton = function (props) { return react_1.default.createElement(button_1.default, tslib_1.__assign({}, props)); };
