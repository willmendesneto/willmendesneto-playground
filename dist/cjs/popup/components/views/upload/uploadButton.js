...
var LocalBrowserButton = /** @class */ (function (_super) {
    ...
    LocalBrowserButton.prototype.render = function () {
        return (react_1.default.createElement(button_1.default, { "data-testid": "media-picker-upload-button", appearance: "default", onClick: this.onUploadClick },
            react_1.default.createElement(react_intl_1.FormattedMessage, tslib_1.__assign({}, media_ui_1.messages.upload_file))));
    };
