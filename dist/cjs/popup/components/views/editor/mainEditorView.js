...
var MainEditorView = /** @class */ (function (_super) {
        ...
        _this.renderContent = function (editorData) {
            ...
            if (error) {
                ...
                return (react_1.default.createElement(styles_1.CenterView, null,
                    react_1.default.createElement(media_editor_1.EditorView, { imageUrl: imageUrl, onSave: _this.onEditorSave(originalFile), onCancel: _this.onCancel, onError: _this.onEditorError })));
            }
            else {
                return react_1.default.createElement(spinnerView_1.SpinnerView, { onCancel: _this.onCancel });
            }
        };
    ...
    MainEditorView.prototype.renderError = function (_a) {
        ...
        return (react_1.default.createElement(errorView_1.default, { message: message, onRetry: retryHandler, onCancel: this.onCancel }));
    };
