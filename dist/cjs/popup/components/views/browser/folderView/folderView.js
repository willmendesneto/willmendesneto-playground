...
var selectedTick = (react_1.default.createElement(styled_1.SelectedFileIconWrapper, null,
...
var FolderViewer = /** @class */ (function (_super) {
    ...
    function FolderViewer() {
        ...
        _this.renderServiceFolder = function (item, itemIcon) {
            return (react_1.default.createElement(styled_1.FolderViewerRow, { onClick: _this.itemClicked(item), key: item.id },
                react_1.default.createElement(styled_1.FileMetadataGroup, null,
                    react_1.default.createElement(styled_1.FileIcon, null, itemIcon),
                    react_1.default.createElement(styled_1.FileName, null, item.name))));
        };
        _this.renderServiceFile = function (serviceFile, itemIcon, isSelected) {
            var tail = isSelected
                ? selectedTick
                : _this.renderFileCreateDateAndSize(serviceFile);
            return (react_1.default.createElement(styled_1.FolderViewerRow, { isSelected: isSelected, onClick: _this.itemClicked(serviceFile), key: serviceFile.id },
                react_1.default.createElement(styled_1.FileMetadataGroup, null,
                    react_1.default.createElement(styled_1.FileIcon, null, itemIcon),
                    react_1.default.createElement(styled_1.FileName, { isSelected: isSelected }, serviceFile.name)),
                tail));
        };
        _this.renderFileCreateDateAndSize = function (_a) {
            var date = _a.date, size = _a.size;
            return (react_1.default.createElement(styled_1.FileMetadataGroup, null,
                react_1.default.createElement(styled_1.FileCreateDate, null, getDateString(date)),
                react_1.default.createElement(styled_1.FileSize, null, filesize_1.default(size))));
        };
    ...
    FolderViewer.prototype.render = function () {
        return (react_1.default.createElement(styled_1.FolderViewerWrapper, null,
    ...
    FolderViewer.prototype.renderFolderContent = function (items) {
        ...
        return (react_1.default.createElement(styled_1.FolderViewerContent, null, [folderItems, this.renderLoadMoreButton()]));
    };
    FolderViewer.prototype.renderLoadMoreButton = function () {
        ...
        if (nextCursor || this.isPageMoreLoading) {
            ...
            react_1.default.createElement(styled_1.MoreBtnWrapper, { key: "load-more-button-wrapper" },
                react_1.default.createElement(button_1.default, { className: "moreBtn", onClick: this.onLoadMoreButtonClick, isDisabled: isLoading }, label)));
        }
        else {
            return null;
        }
