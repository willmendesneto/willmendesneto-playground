...
var serviceDetails = {
    dropbox: {
        name: 'Dropbox',
        icon: react_1.default.createElement(dropbox_1.default, { label: "dropbox", size: "xlarge" }),
    },
    google: {
        name: 'Google Drive',
        icon: react_1.default.createElement(googledrive_1.default, { label: "drive", size: "xlarge" }),
    },
};
/**
...
var StatelessAuth = /** @class */ (function (_super) {
    ...
    StatelessAuth.prototype.render = function () {
        ...
        return (react_1.default.createElement(styled_1.ConnectWrapper, null,
            ...
            react_1.default.createElement(styled_1.IconWrapper, null, icon),
            react_1.default.createElement(styled_1.ButtonWrapper, null,
                react_1.default.createElement(button_1.default, { appearance: "primary", className: "connectBtn", onClick: this.onClick },
