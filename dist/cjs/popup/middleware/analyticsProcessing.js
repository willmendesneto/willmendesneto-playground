...
var createAndFire = function (payload, handlers) {
    ...
    new analytics_next_1.UIAnalyticsEvent({
        context: [{}],
        handlers: handlers,
        payload: tslib_1.__assign(tslib_1.__assign({}, payload), { attributes: tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, payload.attributes), { componentName: 'mediaPicker', packageName: version_json_1.name, componentVersion: version_json_1.version }), (mediaRegion ? { mediaRegion: mediaRegion } : undefined)) }),
