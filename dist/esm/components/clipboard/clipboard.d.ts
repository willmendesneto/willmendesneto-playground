...
export declare const Clipboard: import("react").ForwardRefExoticComponent<Pick<Pick<Pick<ClipboardProps, "onError" | "mediaClient" | "config" | "onUploadsStart" | "onPreviewUpdate" | "onEnd">, "onError" | "mediaClient" | "onUploadsStart" | "onPreviewUpdate" | "onEnd"> & Partial<Pick<Pick<ClipboardProps, "onError" | "mediaClient" | "config" | "onUploadsStart" | "onPreviewUpdate" | "onEnd">, "config">> & Partial<Pick<{
    config: ClipboardConfig;
}, never>> & import("react").RefAttributes<any> & import("@atlaskit/analytics-next/dist/cjs/withAnalyticsContext").WithContextProps, "key" | "onError" | "analyticsContext" | "mediaClient" | "config" | "onUploadsStart" | "onPreviewUpdate" | "onEnd"> & import("react").RefAttributes<any>>;
export {};
