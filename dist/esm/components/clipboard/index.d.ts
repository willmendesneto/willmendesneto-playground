...
export declare class ClipboardLoader extends React.PureComponent<ClipboardWithMediaClientConfigProps, State> {
    ...
    state: {
        Clipboard: React.ComponentClass<WithMediaClientConfigProps<Pick<ClipboardProps, "ref" | "onError" | "createAnalyticsEvent" | "mediaClient" | "onUploadsStart" | "onPreviewUpdate" | "onEnd"> & {
            config?: ClipboardConfig | undefined;
        }>, any> | React.FunctionComponent<WithMediaClientConfigProps<Pick<ClipboardProps, "ref" | "onError" | "createAnalyticsEvent" | "mediaClient" | "onUploadsStart" | "onPreviewUpdate" | "onEnd"> & {
            config?: ClipboardConfig | undefined;
        }>> | undefined;
    };
