...
var ForgeClient = /** @class */ (function () {
    function ForgeClient() {
        var _this = this;
        this.getProviders = function () { return __awaiter(_this, void 0, void 0, function () {
            var response;
        ...
        this.fetch = function (endpoint, body) { return __awaiter(_this, void 0, void 0, function () {
    ...
    ForgeClient.prototype.getApiEndpoint = function () {
        var e_1, _a;
        try {
            for (var TENANT_HOST_REGEX_1 = __values(TENANT_HOST_REGEX), TENANT_HOST_REGEX_1_1 = TENANT_HOST_REGEX_1.next(); !TENANT_HOST_REGEX_1_1.done; TENANT_HOST_REGEX_1_1 = TENANT_HOST_REGEX_1.next()) {
