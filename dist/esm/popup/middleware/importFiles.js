...
var getRemotePreview = function (store, fileId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!isProcessedFileState(userFileState)) {
                    ...
                    return [2 /*return*/, __assign(__assign({}, userFileState), { id: tenantFileId, mediaType: mediaType,
                            preview: preview })];
                }
                _a.label = 2;
 ...
 */
var distributeTenantFileState = function (tenantFileState, userSelectedFileId) { return __awaiter(void 0, void 0, void 0, function () {
    var tenantFileSubject, userFileObservable;
    return __generator(this, function (_a) {
        tenantFileSubject = createFileStateSubject();
        ...
        if (userFileObservable) {
            userFileObservable.subscribe({
                next: function (latestUserFileState) {
                    ...
                    var overrides = !isErrorFileState(tenantFileState)
                        ? {
                            mediaType: tenantFileState.mediaType,
                            preview: tenantFileState.preview,
                        }
                        : {};
                    tenantFileSubject.next(__assign(__assign(__assign({}, latestUserFileState), overrides), { id: tenantFileState.id }));
                },
            });
        }
        return [2 /*return*/];
...
var emitPublicEvents = function (selectedUploadFile, store, localUpload) {
    ...
    var dispatchUploadError = function (fileState) {
        ...
        store.dispatch(sendUploadEvent({ event: event, fileId: fileId }));
    };
    var dispatchUploadPreviewUpdate = function (fileState, value) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, getPreviewFromBlob(value, mediaType)];
                case 1:
                    _a = _b.sent();
                    return [3 /*break*/, 3];
                case 2:
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(canDispatchUploadPreview() &&
                                !isMimeTypeSupportedByBrowser(mimeType))) return [3 /*break*/, 2];
...
var importFilesFromLocalUpload = function (selectedUploadFile, store, localUpload) { return __awaiter(void 0, void 0, void 0, function () {
...
var importFilesFromRecentFiles = function (selectedUploadFile, store) { return __awaiter(void 0, void 0, void 0, function () {
...
var importFilesFromRemoteService = function (selectedUploadFile, store, wsConnectionHolder) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                uploadActivity = new RemoteUploadActivity(tenantFileId, serviceName, function (event, payload) {
                    if (event === 'NotifyMetadata') {
                        ...
                        var newFile = __assign(__assign({}, file), { id: tenantFileId_1, creationDate: Date.now() });
