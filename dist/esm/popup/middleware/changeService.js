...
export var changeService = function (store) { return function (next) { return function (action) { return __awaiter(void 0, void 0, void 0, function () {
    var serviceName, existingAccountId, firstAccount, accountId;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!isChangeServiceAction(action)) return [3 /*break*/, 2];
                serviceName = action.serviceName;
                existingAccountId = store.getState().view.service.accountId;
            ...
            case 1:
                ...
                accountId = existingAccountId || (firstAccount ? firstAccount.id : '');
