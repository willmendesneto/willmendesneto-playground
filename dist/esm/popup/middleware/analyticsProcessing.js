...
var createAndFire = function (payload, handlers) {
    ...
    new UIAnalyticsEvent({
        context: [{}],
        handlers: handlers,
        payload: __assign(__assign({}, payload), { attributes: __assign(__assign(__assign({}, payload.attributes), { componentName: 'mediaPicker', packageName: name, componentVersion: version }), (mediaRegion ? { mediaRegion: mediaRegion } : undefined)) }),
